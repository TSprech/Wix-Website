class Radio_Switch_Slideshow {
	constructor(slideshow_name, radio_button_group_name, switch_name, debug, initialization_slide, initialization_radio, initialization_switch) {
        ...
        if (this._debug_bool) { console.log(this._slideshow_id + " has an initial slide value of " + initialization_slide + " and the radio buttons modifier " + this._radio_buttons_id + " which has an initial value of " + initialization_radio + " with a switch modifier " + this._switch_id + "which has an initial value of " + initialization_switch + "\n\n"); }
